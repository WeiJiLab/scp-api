...
import com.thoughtworks.security.scpapi.JUnitWebAppTest;
...
public class SecurityToolControllerTest {
    ...
    private CreateSecurityToolRequest getCreateSecurityToolRequest() {
        return CreateSecurityToolRequest
                .builder()
                .category(SecurityToolCategory.SCA)
                .description("SCA")
                .name("SCA-Test")
    ...
    public class CreateSecurityTool {
        ...
        public void should_create_SecurityTool_when_given_one_CreateSecurityToolRequest() throws Exception {
            ...
            // given
            CreateSecurityToolRequest request = getCreateSecurityToolRequest();
        ...
        private void createIsBadRequest(CreateSecurityToolRequest request) throws Exception {
