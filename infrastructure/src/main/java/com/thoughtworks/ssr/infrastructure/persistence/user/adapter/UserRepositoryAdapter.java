package com.thoughtworks.ssr.infrastructure.persistence.user.adapter;

import com.thoughtworks.ssr.domain.user.model.User;
import com.thoughtworks.ssr.domain.user.repository.UserRepository;
import com.thoughtworks.ssr.infrastructure.persistence.user.converter.UserEntityConverter;
import com.thoughtworks.ssr.infrastructure.persistence.user.repository.UserJpaRepository;
